...
public:
	...
	void DisplayAllStations(ItemType linecode);
	...
	void DisplayStationInfo(ItemType name);
...
public: //where all the methods are stored
	...
	bool FindRoute(ItemType source, ItemType destination);
	...
	bool AddNewLine(ItemType stationcode, ItemType stationname, ItemType stationname1);
	...
	bool DisplayPossibleRoutes(ItemType source, ItemType destination);
